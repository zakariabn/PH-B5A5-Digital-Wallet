...
const generateHash = (password) => __awaiter(void 0, void 0, void 0, function* () {
    return yield bcryptjs_1.default.hash(password, Number(env_1.env.BCRYPT_SALT_ROUND));
});
exports.generateHash = generateHash;
const validateHash = (password, hashPassword) => __awaiter(void 0, void 0, void 0, function* () {
