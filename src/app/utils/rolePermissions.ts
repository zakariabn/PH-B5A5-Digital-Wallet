...
export type Permission = 'canViewUsers' | 'canViewAgents' | 'canViewWallets' | 'canViewTransactions' | 'canBlockWallets' | 'canUnblockWallets' | 'canApproveAgents' | 'canSuspendAgents' | 'canSetSystemParameters' | 'canAddMoney' | 'canWithdrawMoney' | 'canSendMoney' | 'canCashIn' | 'canCashOut' | 'canViewCommission';
